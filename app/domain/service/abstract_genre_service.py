...
class AbstractGenreService(ABC):
    ...
    def _normalize_track_list(self, track_response, genre) -> List[Track]:
        track_list = []
        ...
        for track_info in track_response['tracks']['items']:
            track_list.append(Track(name=track_info['name'], artist=track_info['artists'][0]['name'], genre=genre))
